...
public class Oscilloscope implements MessageListener
{
    ...
    if (msg instanceof OscilloscopeMsg) {
        ...
        data.update(omsg.get_nodeid(), omsg.get_counter(), new DataType(omsg.get_temperature(), omsg.get_humidity(), omsg.get_light(), omsg.get_counter(), omsg.get_total_time(), omsg.get_node2_retrans(), omsg.get_node1_overflow(), omsg.get_node0_retrans(), omsg.get_factor()));
